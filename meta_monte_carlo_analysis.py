...
print(f"Последняя дата: {last_date.date()}, цена S0 = {S0:.2f}")
...
print(f"Среднее: {mean_final:.2f}")
print(f"Медиана: {q50:.2f}")
print(f"5%–95% квантили:  [{q05:.2f}, {q95:.2f}]")
print(f"25%–75% квантили: [{q25:.2f}, {q75:.2f}]")
print(f"P(рост):         {prob_up:.1%}")
